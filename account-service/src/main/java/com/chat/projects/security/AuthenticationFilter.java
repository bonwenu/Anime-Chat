...
import static com.chat.projects.security.SecurityConstants.*;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            ...
            System.out.println("Authenticate " + applicationUser.getUsername() + " " +applicationUser.getPassword());
    ...
    protected void successfulAuthentication(HttpServletRequest req, HttpServletResponse res, FilterChain chain,
        ...
        // JWT was added for personal reasons. Not really needed.
        res.addHeader("token", "JWT "+ token);
